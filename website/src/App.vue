  ...
  <div id="app">
      ...
      <article class="post">
        <header>
          ...
          <div class="meta">
            ...
            <a href="#" class="author">
              <span class="name">Jane Doe</span><img src="./static/img/avatar.jpg" alt="" /></a>
          </div>
        </header>
      ...
      <article class="post">
        <header>
          ...
          <div class="meta">
            ...
            <a href="#" class="author">
              <span class="name">Jane Doe</span><img src="/assets/img/avatar.jpg" alt="" /></a>
          </div>
        </header>
    ...
    <section id="sidebar">
      ...
      <section id="footer">
        ...
        <p class="copyright">&copy; Untitled. More Templates
